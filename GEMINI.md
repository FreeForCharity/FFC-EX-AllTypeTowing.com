# Gemini Instructions: FFC-EX-AllTypeTowing.com

Hey Gemini! Welcome to FFC-EX-AllTypeTowing.com.

**Project:** FFC-EX-AllTypeTowing.com -- a Free For Charity nonprofit website for AllTypeTowing.com
...
The site deploys to `https://freeforcharity.github.io/FFC-EX-AllTypeTowing.com/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
